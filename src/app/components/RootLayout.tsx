              ...
              {navItems.map((item) => (
                <Link
                  ...
                  className={`transition-colors hover:text-yellow-500 ${
                    isActive(item.path) ? "text-yellow-500 border-b-2 border-yellow-500 pb-1" : "text-gray-300"
                  }`}
                >
                  {item.label}
                </Link>
      ...
      <footer className="bg-black text-white mt-16 border-t-2 border-yellow-600">
        <div className="container mx-auto px-4 py-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4 text-yellow-500">MAJESTIC INTERIOR DESIGN</h3>
